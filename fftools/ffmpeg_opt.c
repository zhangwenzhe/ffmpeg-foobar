...
static int open_input_file(OptionsContext *o, const char *filename)
{
    ...
    if (o->format) {
		av_log(NULL, AV_LOG_INFO, "zzzz format is %s\n", o->format);//zwz
    ...
    if (video_codec_name){
		...
		av_log(NULL, AV_LOG_INFO, "zzzz find vcodec\n");//zwz
	...
	av_log(NULL, AV_LOG_INFO, "zzzz vcodec is %d\n", ic->video_codec_id);//zwz
	...
	av_log(NULL, AV_LOG_INFO, "zzzz avformat_open_input, filename %s, dic count %d\n", 
		filename, av_dict_count(o->g->format_opts));
	char *zbuffer = NULL;
    av_dict_get_string(o->g->format_opts, &zbuffer, '=', ',');
	...
	av_log(NULL, AV_LOG_INFO, "zzzz nb_streams %d\n", ic->nb_streams);//zwz
...
static int open_output_file(OptionsContext *o, const char *filename)
{
	...
	av_log(NULL, AV_LOG_INFO, "zzzz output format %s\n", o->format);//zwz
